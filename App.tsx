                        ...
                        <div className="lg:col-span-2 space-y-6">
                          ...
                          <div className="bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm space-y-6">
                            ...
                            <div className="space-y-2">{(currentMeeting.participants || []).map((p:any, i:any) => (
                              <div key={`${currentMeeting.id}-p-${i}`} className="flex justify-between items-center p-4 bg-slate-50 rounded-lg border border-slate-100 group transition-all hover:bg-white hover:shadow-md font-bold italic">
